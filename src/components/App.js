...
class App extends Component {
  ...
  async loadEthSwapWebSocket(){
    ...
    if (web3Socket){      
      ...
      // if(ethSwapWebSocketData) {
        ...
        // =========== contract address ===========
        const ethSwapWebSocket = await new web3Socket.eth.Contract(EthSwap, "0x2cA7Eb672bC67854C410Ab2d821124fdFE34d60A")
  ...
  async loadBlockchainData() {
    ...
    // if(tokenData) {
      const token = new web3.eth.Contract(Token, "0xF63271E57C1267338B3a016a7826eb59ED50e152")
      this.setState({ token })
    ...
    // if(ethSwapData) {
      const ethSwap = new web3.eth.Contract(EthSwap, "0x2cA7Eb672bC67854C410Ab2d821124fdFE34d60A")
      this.setState({ ethSwap })

      const tokenPrice = new web3.eth.Contract(TokenPrice, "0xD29592e81b38ab1257eAc86C9DD12AB07071eDb0")
    ...
    //load USDT 
    const usdt = new web3.eth.Contract(Usdt, "0x01A0930263b9F19C87Fb16F33fBE2D9A6a0963c8")
      this.setState({ usdt })
